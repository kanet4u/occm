...
@Controller
@RequestMapping(value = { AdminPageController.URL_MAPPING })
public class AdminPageController {
	public static final String URL_MAPPING = "/admin/page";
	...
	public String index(final RedirectAttributes redirectAttributes,
		...
		if (hs.getAttribute("pages_list") == null) {
			redirectAttributes.addFlashAttribute("message_error",
					"Permission denied!");
			return "redirect:/admin";
		}
		map.addAttribute("pages", service.getPageList());
	...
	public String submissionDelete(@PathVariable("id") Long id,
			...
			ModelMap map,
			HttpSession hs) {
		if (hs.getAttribute("pages_delete") == null) {
			redirectAttributes.addFlashAttribute("message_error",
					"Permission denied!");
		} else {
